...
(*.[0-9]*)
	...
	if test ! -f /home/wc/Code_program/Linux/ncurses-6.2/man_alias.sed ; then
cat >>/home/wc/Code_program/Linux/ncurses-6.2/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/wc/Code_program/Linux/ncurses-6.2/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/wc/Code_program/Linux/ncurses-6.2/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /home/wc/Code_program/Linux/ncurses-6.2/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/wc/Code_program/Linux/ncurses-6.2/man_alias.sed \
		< $i | sed -f /home/wc/Code_program/Linux/ncurses-6.2/edit_man.sed >$TMP
